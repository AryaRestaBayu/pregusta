...
class _CalendarState extends State<Calendar> {
  ...
  Future updateAbsen() async {
    FirebaseFirestore.instance
        .collection('absen')
        .doc(FirebaseAuth.instance.currentUser!.uid)
        .set({
      'mySelectedEvent': mySelectedEvents,
    });
  }
          ...
          children: [
            ...
            DropdownButtonHideUnderline(
              child: DropdownButtonFormField(
                ...
                //
                items: itemAbsen.map((String itemAbsen) {
                  return DropdownMenuItem(
                    value: itemAbsen,
                    child: Text(itemAbsen),
                  );
                }).toList(),
                //
            ...
            GestureDetector(
              onTap: () async {
                ...
                Reference referenceDirImage =
                    referenceRoot.child(FirebaseAuth.instance.currentUser!.uid);
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () {
              if (imageUrl == '') {
                Utils.showSnackBar(
                    "Sedang upload foto, tunggu sebentar", Colors.red);
                return;
              }
              setState(() {
                if (mySelectedEvents[
                      ...
                      ..._listOfDayEvents(_selectedDate!).map((myEvents) =>
                          Column(
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.only(top: sizeHeight * 0.00),
            ...
            child: GestureDetector(
              ...
              child: Container(
                  margin: EdgeInsets.only(
                      bottom: sizeHeight * 0.03, right: sizeHeight * 0.03),
